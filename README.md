        ...
        <section id="inicio" class="my-5">
            <div class="inicio-fundo d-flex justify-content-between align-items-center">
                ...
                <img src="img/lossy-page1-640px-Os_Mutantes.tif (1).png"
                    alt="A imagem apresenta um croqui de moda"
                    title="o criqui - CC0 Domínio Público / Acervo Arquivo Nacional" class="img-fluid img-inicio">

            </div>
        </section>

        <section id="fernandes " class="my-5 pt-6 secao-fernandes">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center ">
                    <img src="img/image (1).png" class="rounded-pill" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>O que é a Fernandes?</h2>
                    <p class="p-2">A Fernandes é uma confecção com produção propria, focamos em peças exclusivas. Ela começou com um sonho de criança e muitas roupinhas de bonecas.</p>
                </div>
            </div>
        </section>
